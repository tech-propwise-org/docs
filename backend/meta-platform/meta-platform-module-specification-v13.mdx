---
title: "Meta Platform Module Specification v13"
description: "Comprehensive specification for the Meta Platform integration module, including Graph API service, OAuth handling, and webhook validation"
---
...
<CardGroup cols={2}>
  ...
  <Card title="MetaOAuthService" icon="lock">
...
<Steps>
  <Step title="Update Environment Variable">
    Change the relevant API version environment variable
  </Step>
...
<Check>**Upgrade procedure:** Update the env var, deploy, and test. No code changes needed.</Check>
...
<Check>**Webhook Capacity Guard**: Meta webhook POST endpoints use explicit high throttles (1000/min) and verification GET endpoints use low throttles (20/min). Do not use `@SkipThrottle()` on Meta webhook controllers.</Check>

<Check>**Token Management**: OAuth tokens should be properly managed and refreshed as needed</Check>