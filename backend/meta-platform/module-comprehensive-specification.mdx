---
title: "Module Comprehensive Specification"
description: "Complete technical specification for the Meta Platform module including services, authentication, error handling, and configuration"
---
...
<Warning>
All webhook requests must include valid `x-hub-signature-256` header for security validation.
</Warning>
...
Modify the appropriate env var to the new API version
</Step>
...
<CardGroup cols={2}>
<Card title="Service Imports" icon="code">
`MetaPlatformModule` is imported by `MessagingModule` providing MetaGraphApiService, MetaOAuthService, and InstagramOAuthService
</Card>
...
<Warning>
Security is paramount when handling Meta webhook requests and API communications.
</Warning>
