---
title: "Meta Platform Module Specification v29"
...
<AccordionGroup>
  <Accordion title="app.meta.graphApiBaseUrl">
    Base URL for Graph API (defaults to `https://graph.facebook.com`)
  </Accordion>
  <Accordion title="app.meta.whatsappApiVersion">
    Default API version for WhatsApp operations (default `v25.0` as of 2026-06-10)
  </Accordion>
  <Accordion title="app.meta.instagramApiVersion">
    Default API version for Instagram operations (default `v25.0`)
  </Accordion>
  <Accordion title="app.meta.messengerApiVersion">
    Default API version for Messenger operations (default `v25.0`)
  </Accordion>
  <Accordion title="app.meta.oauthApiVersion">
    API version for OAuth flows (default `v25.0`)
  </Accordion>
</AccordionGroup>
...
<Steps>
  <Step title="Update environment variable">
    Modify the appropriate `META_*_API_VERSION` environment variable to the new version
  </Step>
  <Step title="Deploy the changes">
    Deploy the updated configuration to your environment
  </Step>
  <Step title="Test functionality">
    Verify that all API calls work correctly with the new version
  </Step>
</Steps>
...
<Note>
The `externalEventId` field enforces webhook idempotency through a unique constraint, preventing duplicate processing of the same event.
</Note>