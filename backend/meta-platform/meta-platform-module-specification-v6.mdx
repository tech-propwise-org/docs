---
title: "Meta Platform Module Specification v6"
description: "Complete specification for Meta Platform integration including Graph API service, OAuth handling, webhook validation, and error management for Facebook, Instagram, and WhatsApp channels."
---
...
<Steps>
  ...
  <Step title="Test integration">
    Verify that Meta API calls work with the new version
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="MetaGraphApiService">
    For all outbound API calls (send messages, upload media, manage templates, webhook unsubscription on channel account deletion)
  </Card>
  <Card title="MetaOAuthService">
    For personal account OAuth flows (Instagram, Messenger)
  </Card>
  <Card title="InstagramOAuthService">
    For Instagram Login OAuth flows and webhook subscription
  </Card>
  <Card title="Webhook Components">
    MetaWebhookGuard, InstagramWebhookGuard, and WebhookEventLog entity
  </Card>
</CardGroup>
...
<Info>
**Error Classification**: API errors are categorized by Meta-specific error codes for appropriate handling
</Info>