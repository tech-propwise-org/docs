...
description: "Complete specification for the AI Conversation System, including modes, pipeline integration, LLM providers, and response generation"
---
...
Check escalation triggers before generating. If escalation triggered → set aiMode = OFF, notify agent, skip.
</Tab>
...
<CardGroup cols={2}>
  <Card title="AI Performance Dashboard" href="/analytics/ai-metrics">
    View detailed AI conversation analytics and performance metrics
  </Card>
  <Card title="Escalation Monitoring" href="/analytics/escalation-trends">
    Monitor escalation patterns and optimize AI triggers
  </Card>
</CardGroup>