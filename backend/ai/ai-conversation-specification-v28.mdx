---
title: "AI Conversation System Specification v28"
description: "Complete specification for the AI conversation system including customer-facing messaging AI, internal assistant boundaries, AI modes, decision pipeline, and LLM integration architecture."
---

# AI Conversation System Specification v28
...
<Info>
The internal assistant enforces a **scope + refusal + groundedness + Propwise-glossary + multi-turn-follow-ups + lead-routing** system prompt (current version `AI_ASSISTANT_SYSTEM_PROMPT_VERSION = crm-assistant-v0.6-lead-routing`).
</Info>
...
Initial message processing begins
</Step>
