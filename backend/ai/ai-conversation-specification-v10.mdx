---
title: "AI Conversation Specification v10"
...
flowchart TD
    ...
    M -->|Continue| O[Compose prompt context]
...
<Tip>
Token counting uses the provider's tokenizer (tiktoken for OpenAI, approximate for others). Maximum context window: 8,000 tokens for prompt (conservative default).
</Tip>
...
<Check>
These metrics provide visibility into AI adoption, effectiveness, and escalation patterns across your organization.
</Check>