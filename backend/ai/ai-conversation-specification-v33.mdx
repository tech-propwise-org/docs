---
title: "AI Conversation Specification v33"
description: "Comprehensive specification for the AI conversation system including customer-facing messaging AI, modes, pipeline flow, and LLM integration architecture"
---
...
Focus on understanding their real estate needs and connecting them with appropriate properties or services.
Keep responses concise and friendly.
```

<CardGroup cols={2}>
<Card title="Next: Escalation Triggers" href="#escalation-system">
Learn about automatic escalation to human agents
</Card>
<Card title="Related: Message Templates" href="/backend/messaging/templates">
Configure AI prompts and response templates
</Card>
</CardGroup>