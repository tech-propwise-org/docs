---
title: "AI Conversation Specification v15"
description: "Comprehensive specification for the AI conversation system with LLM integration, response modes, and context composition"
---
...
<Note>
This system is designed to be non-blocking and fault-tolerant. AI failures will never prevent message delivery or processing.
</Note>
...
<Steps>
  <Step title="Inbound Message Received">
    The message enters the webhook processing pipeline
  </Step>
  ...
  <Step title="Phase B: Side-effects">
    Non-critical processing occurs in isolated try-catch blocks:
  ...
  <Step title="AI Processing">
    <AccordionGroup>
      ...
      <Accordion title="Generate response">
...
<Warning>
All AI errors are logged but never thrown to avoid blocking the agent workflow
</Warning>
...
<Info>
These metrics provide visibility into AI adoption and effectiveness across the organization.
</Info>