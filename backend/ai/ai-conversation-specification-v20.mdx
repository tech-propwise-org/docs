---
title: "AI Conversation System v20"
description: "Complete specification for the AI Conversation System including automated responses, AI modes, LLM integration, and escalation handling within the unified messaging module."
---
...
Non-critical, isolated processing including:
...
The AI Response Pipeline handles:
- Conversation AI mode checking
- Escalation trigger evaluation
- Prompt context composition
- LLM provider calls
- Response processing by mode
- AI message counter incrementing
</Step>
</Steps>
...
<Warning>
Target latency budget: **< 5 seconds** end-to-end for AI response generation
</Warning>
...
The system uses a clean abstraction layer for LLM providers:
...
```typescript LlmResponse Interface
...
<AccordionGroup>
<Accordion title="1. System Prompt">
...
const systemPrompt = template?.systemPrompt?.prompt ?? 
  template?.body ?? DEFAULT_SYSTEM_PROMPT;
```
</Step>
...
Handle response based on the conversation's AI mode (AUTO_REPLY, SUGGEST_ONLY, or DRAFT).
</Step>
...
<Warning>
All AI errors are non-blocking. The system prioritizes message delivery over AI functionality.
</Warning>
...
<Check>
These metrics provide insights into AI effectiveness and help optimize escalation thresholds and AI performance across organizations.
</Check>