...
// Inheritance flow for deal creation from lead
if (lead.propertyInterest) {
  deal.propertyInterest = {
    dealId: deal.id,
    developmentId: lead.propertyInterest.developmentId,
    unitId: lead.propertyInterest.unitId,
    budgetMin: lead.propertyInterest.budgetMin,
    budgetMax: lead.propertyInterest.budgetMax,
    originatingInterestId: lead.propertyInterest.id
  }
}
```
