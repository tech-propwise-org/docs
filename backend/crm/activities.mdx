...
<Note>
Existing IDs do not change when the organization is renamed. Organization user memberships also receive stable fallback avatar colors from the user sequence for consistent visual identity.
</Note>
