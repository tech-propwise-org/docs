...
### Activity-triggered transitions
...
<Tabs>
<Tab title="Stage-based assignment">
```sql
...
<Tab title="Auto-assignment rules">
...
<Tabs>
<Tab title="Stage-activity patterns">
```sql
...
<Tab title="Stage transition triggers">
...
<Tabs>
<Tab title="Commission generation">
