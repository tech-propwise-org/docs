...
├── Preferences: timezone, custom_fields jsonb
...
└── Related Tables:
    ...
    ├── Tag (polymorphic via entity_type/entity_id)
    ├── Activity (polymorphic via entity_type/entity_id)
    └── Note (polymorphic via entity_type/entity_id)
```
