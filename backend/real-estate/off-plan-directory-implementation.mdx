...
description: "Detailed implementation specification for the Off-Plan Directory feature including frontend components, API layer, and navigation structure"
---
...
<Accordion title="Additional Types">
...
offPlan: {
  ...
  buildings: {
    ...
    units: (buildingId: number) => 
      [...queryKeys.offPlan.buildings.all(), buildingId, 'units'] as const,
  },
  map: {
  ...
  units: {
    ...
    detail: (id: number) => 
      [...queryKeys.offPlan.units.all(), 'detail', id] as const,
  },
  filters: {
...
<Note>
This query key structure follows the established patterns in the codebase and ensures proper cache management for all off-plan related data.
</Note>

## Implementation Priority

<CardGroup cols={2}>
<Card title="Phase 1: Core Structure" icon="foundation">
1. Sidebar navigation update
2. Route structure setup
3. API layer implementation
4. Basic list page with grid view
</Card>
<Card title="Phase 2: Enhanced Features" icon="rocket">
1. Map view integration
2. Advanced filters
3. Building detail pages
4. Unit modal and interactions
</Card>
</CardGroup>

<Check>
This implementation leverages existing backend infrastructure while providing a modern, feature-rich off-plan directory that matches competitor platforms.
</Check>