...
description: "Complete API reference guide for Property Finder integration including authentication, authorization, and endpoint documentation"
---
...
<Steps>
<Step title="Log into PF Expert">
Open the **PF Expert** application and log in with your credentials.
</Step>

<Step title="Navigate to API credentials">
Navigate to the **API Credentials** section under the **Developer Resources** tab in the left sidebar.
</Step>

<Step title="Generate credentials">
Generate a new API key and API secret. Be sure to use the type as **API Integration**.
</Step>
</Steps>
...
- Required scopes are documented at both the endpoint level and the Endpoint-to-Scope Mapping section
...
<Accordion title="Role endpoints">
...
<Accordion title="Location endpoints">
...
<Accordion title="Project endpoints">
