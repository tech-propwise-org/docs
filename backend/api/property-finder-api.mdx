...
description: "Complete API documentation for Property Finder's external APIs including authentication, authorization, and endpoint reference"
---
...
<AccordionGroup>
<Accordion title="Endpoint-to-scope mapping">
