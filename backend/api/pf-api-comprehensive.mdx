...
description: "Complete API documentation for Property Finder's external APIs including authentication, authorization, and endpoint specifications"
---
...
<Accordion title="Data access endpoints">
| Name | Method | Endpoint | Scope Required |
| --- | --- | --- | --- |
...
<Accordion title="Verification and compliance endpoints">
| Name | Method | Endpoint | Scope Required |
| --- | --- | --- | --- |
